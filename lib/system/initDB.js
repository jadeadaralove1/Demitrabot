...
function initDB(m, client) {
  ...
  settings.nameid ??= "Demitra bot"
  settings.type ??= 'Owner'
  settings.link ??= 'https://whatsapp.com/channel/0029VbBvrmwC1Fu5SYpbBE2A'
  settings.banner ??= 'https://files.catbox.moe/gxmf27.jpg'
  settings.icon ??= 'https://files.catbox.moe/1yqi1c.jpg'
  settings.currency ??= 'Demitracoin'
  settings.namebot ??= 'Demitra'
  settings.botname ??= 'Demitra bot'  
  settings.owner ??= ''
