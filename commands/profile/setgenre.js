export default {
  ...
  run: async (client, m, args, usedPrefix, command) => {
    ...
    if (!input) return m.reply(`ᘛ  ࣭  🦭⃝   ࣪  ࣭Debes ingresar un género válido.\n>  Ejemplos:\n> *${usedPrefix + command} hombre*\n> *${usedPrefix + command} mujer*`)
    ...
    if (!genre) {
      ...
      return m.reply(`૮₍˶• ˔ ก₎ა Elije un género válido.\n\nOpciones:\n${opciones}`)
    }
    user.genre = genre
    return m.reply(`₍⑅ᐢ..ᐢ⑅₎ Se ha establecido tu género como: *${user.genre}*`)
  },
}